...
const SideNav = (props) => {
  ...
  return (
    <div className={`${classes.container} ${hide} ${dark}`} onClick={sideNavClickHandler}>
      ...
      <div className={classes.toggle_group}>
        <div
          className={`${classes.toggler} ${dark}`}
        ...
        >
          ...
          <div className={`${classes.toggle} ${dark}`}>
            <span></span>
          </div>
        ...
        {!props.isPhone && (
          <div className={classes.hide_nav} onClick={hideSidenavHandler}>
